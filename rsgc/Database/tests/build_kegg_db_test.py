...
init_db.Createdb(PATH+'/kbasetestaddKEGG.db', False)
bkdb.BuildKbase(PATH+'/datam', PPATH+'/data/KbasetoKEGGCPD.txt', PPATH+'/data/KbasetoKEGGRXN.txt',
                False, PATH+'/kbasetestaddKEGG.db', 'bio')
DB = Q.Connector(PATH+'/kbasetestaddKEGG.db')
kbaserxnsadd = DB.get_all_reactions()
kbaserxnsadd1 = deepcopy(kbaserxnsadd)

init_db.Createdb(PATH+'/kbasetestaddinchiKEGG.db', True)
bkdb.BuildKbase(PATH+'/data', PPATH+'/data/KbasetoKEGGCPD.txt', PPATH+'/data/KbasetoKEGGRXN.txt',
                True, PATH+'/kbasetestaddinchiKEGG.db', 'bio')
DBinchi = Q.Connector(PATH+'/kbasetestaddinchiKEGG.db')
...
class BuildKEGG(unittest.TestCase):
    ...
    def test_KEGG_with_only_KEGG_orgs(self):
        ...
        K = bkeggdb.CompileKEGGIntoDB(PATH+'/kbasetestaddKEGG.db', 'bacteria', False, 1, 2, 2, 'bio', True)
        DBadd = Q.Connector(PATH+'/kbasetestaddKEGG.db')
        newrxns = set()
        ...
        self.assertEqual(len(kbaserxnsadd1)+len(inter), len(kbaserxnsadd)-1)
    ...
    def test_KEGG_with_only_KEGG_orgsinchi(self):
        """test KEGG database construction"""
        K = bkeggdb.CompileKEGGIntoDB(PATH+'/kbasetestaddinchiKEGG.db', 'bacteria', True, 4, 2, 2, 'bio', True)
        DBaddinchi = Q.Connector(PATH+'/kbasetestaddinchiKEGG.db')
        newrxns = set()
        with open('newrxns.txt') as fin:
            for line in fin:
                line = line.strip()
        ...
        self.assertEqual(len(kbaserxns1inchi)+len(inter), len(kbaserxnsadd)-1)
        ...
        cas = DBaddinchi.get_cpd_casnumber('InChI=1S/H5O10P3/c1-11(2,3)9-13(7,8)10-12(4,5)6/h(H,7,8)(H2,1,2,3)(H2,4,5,6)_c0')
        self.assertEqual(cas, 'None')
        cas = DBaddinchi.get_cpd_casnumber('InChI=1S/H5O10P3/c1-11(2,3)9-13(7,8)10-12(4,5)6/h(H,7,8)(H2,1,2,3)(H2,4,5,6)_c0')
        self.assertEqual(cas, 'None') 
        cas = DBaddinchi.get_cpd_casnumber('InChI=1S/C6H8O7/c7-3(8)1-2(5(10)11)4(9)6(12)13/h2,4,9H,1H2,(H,7,8)(H,10,11)(H,12,13)_c0')
        self.assertEqual(cas, '320-77-4')
   
        cf = DBaddinchi.get_cpd_chemicalformula('InChI=1S/H5O10P3/c1-11(2,3)9-13(7,8)10-12(4,5)6/h(H,7,8)(H2,1,2,3)(H2,4,5,6)_c0')
        self.assertEqual(cf, 'H5O10P3')
        cf = DBaddinchi.get_cpd_chemicalformula('InChI=1S/C6H12O6/c7-1-2-3(8)4(9)5(10)6(11)12-2/h2-11H,1H2/t2-,3-,4+,5-,6-/m1/s1_c0')
        self.assertEqual(cf, 'C6H12O6')
...
if __name__ == '__main__':
    ...
    os.remove(PATH+'/kbasetestaddKEGG.db')
    os.remove(PATH+'/kbasetestaddinchiKEGG.db')
