...
bkdb.BuildKbase(PATH+'/data7', PPATH+'/data/KbasetoKEGGCPD.txt',
                PPATH+'/data/KbasetoKEGGRXN.txt', False,
                PATH+'/test.db', 'bio')
...
class RDFileReaderTests(unittest.TestCase):
    ...
    def tests_RDFileReader(self):
        ...
        Q = cnx.execute("SELECT chemicalformula FROM compound WHERE ID = ?", ('InChI=1S/C11H10O/c1-12-11-7-6-9-4-2-3-5-10(9)8-11/h2-8H,1H3_c0',))
        result = Q.fetchone()
        ...
        Q = cnx.execute("SELECT chemicalformula FROM compound WHERE ID = ?", ('InChI=1S/C6H7N/c7-6-4-2-1-3-5-6/h1-5H,7H2_c0',))
        result = Q.fetchone()
        self.assertEqual(('C6H7N',), result)
        '''reaction_compound check'''
        Q = cnx.execute("SELECT * FROM reaction_compound WHERE reaction_ID = ?", ('rxn1_s',))
        result = Q.fetchall()
        self.assertIn(('rxn1_s', 'InChI=1S/C7H9N/c1-6-2-4-7(8)5-3-6/h2-5H,8H2,1H3_c0', 0, 1,
                       0), result)
        self.assertIn(('rxn1_s', 'InChI=1S/C17H18N2/c1-12-3-5-16-14(7-12)9-18-11-19(16)10-15-8-13(2)4-6-17(15)18/h3-8H,9-11H2,1-2H3_c0', 1, 1, 0),
                      result)


        Q = cnx.execute("SELECT * FROM reaction_compound WHERE reaction_ID = ?", ('rxn3_s',))
        result = Q.fetchall()
        self.assertIn(('rxn3_s', 'InChI=1S/C11H15BO2/c1-11(2)8-13-12(14-9-11)10-6-4-3-5-7-10/h3-7H,8-9H2,1-2H3_c0', 0, 1, 0),
                      result)
        ...
        Q = cnx.execute("SELECT * FROM reaction_catalysts WHERE reaction_ID = ?",
                        ('rxn1_s',))
        result = Q.fetchall()
        self.assertIn(('rxn1_s', 'InChI=1S/C2HF3O2/c3-2(4,5)1(6)7/h(H,6,7)_c0', 'None'),
                      result)
        ...
        result = Q.fetchall()
        self.assertIn(('rxn3_s', 'InChI=1S/C7H8/c1-7-5-3-2-4-6-7/h2-6H,1H3_c0', 'None'),
                      result)
        ...
        Q = cnx.execute("SELECT * FROM reaction_spresi_info WHERE reaction_ID = ?",
                        ('rxn5_s',))
        result = Q.fetchall()
        self.assertIn(('rxn5_s', '25 degree,80 degree,None, 600 degree', 'None,None,None,None',
        ...
        Q = cnx.execute("SELECT * FROM reaction_spresi_info WHERE reaction_ID = ?",
                        ('rxn6_s',))
        result = Q.fetchall()
        self.assertIn(('rxn6_s', 'None', 'None', 'None', 'None',
    ...
    def tests_RDFileReader_inchi(self):
        ...
        self.assertIn(('rxn1_s', 'InChI=1S/C7H9N/c1-6-2-4-7(8)5-3-6/h2-5H,8H2,1H3_c0', 0, 1,
                       0), result)
        self.assertIn(('rxn1_s', 'InChI=1S/C17H18N2/c1-12-3-5-16-14(7-12)9-18-11-19(16)10-15-8-13(2)4-6-17(15)18/h3-8H,9-11H2,1-2H3_c0', 1, 1, 0), result)

        Q = cnx.execute("SELECT * FROM reaction_compound WHERE reaction_ID = ?", ('rxn3_s',))
        result = Q.fetchall()
        self.assertIn(('rxn3_s', 'InChI=1S/C11H15BO2/c1-11(2)8-13-12(14-9-11)10-6-4-3-5-7-10/h3-7H,8-9H2,1-2H3_c0', 0, 1, 0), result)
