...
class Generate_databaseTests_PubchemTrue(unittest.TestCase):
    ...
    def test_build_kbase(self):
        ...
        bkdb.BuildKbase(PATH+'/data', '../data/KbasetoKEGGCPD.txt', '../data/KbasetoKEGGRXN.txt',
                        False, PATH+'/test.db', 'bio')
        ...
        self.assertIn(('cpdA_c0', 'cpdA_c0', 'c0', 'None', 'None', 'None'), results_compound)
        self.assertIn(('cpdB_c0', 'cpdB_c0', 'c0', 'None', 'None', 'None'), results_compound)
        self.assertIn(('cpdF_c0', '2_keto_3_deoxygluconate_c0', 'c0', 'None', 'None',  'None'), results_compound)
