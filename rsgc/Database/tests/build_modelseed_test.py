...
username = input("Please input patric username...")
password = input("Please input patric password...")

PATH = os.path.dirname(os.path.abspath(__file__))

init_db.Createdb(PATH+'/testPATRIC.db')
init_db.Createdb(PATH+'/testPATRICinchi.db')
...
if 'testmodel1' not in models_in_ws_id:
    patric_model1 = mackinac.create_patric_model(str(551115.6), 'testmodel1', media_reference='/chenry/public/modelsupport/media/Complete') #Carbon-D-Glucose'
print ('Get 329726.14')
if 'testmodel2' not in models_in_ws_id:
    patric_model2 = mackinac.create_patric_model(str(329726.14), 'testmodel2', media_reference='/chenry/public/modelsupport/media/Complete') #Carbon-D-Glucose'
...
class BuildKEGG(unittest.TestCase):
    ...
    def test_patric(self):
        ...
        self.assertEqual(len(all_rxns), 1382) 
...
if __name__ == '__main__':
    ...
    os.remove(PATH+'/testPATRICinchi.db')