...
class Solution:
    ...
    '''
    def __init__(self, sol_id = 0, sequence="", cds_region = None, keep_aa = False, 
                    mutable_region = None, parent=None, design = None, cai_table=cai_table):
    ...
    def randomMutation(self,pos=None,n_mut=[1,2]):                      
        new_seq = randomMutationOperator(self.sequence, self.keep_aa, self.mutable_region, 
                        self.cds_region, pos,n_mut,data_table=self.cai_table)     
